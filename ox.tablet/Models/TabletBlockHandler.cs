...
namespace OX.Tablet
{
    ...
    public abstract class BaseTabletBlockHandler : UntypedActor
    {
        ...
        public BaseTabletBlockHandler(OXSystem system)
        {
    ...
    public class TabletBlockHandler : BaseTabletBlockHandler
    {
        ...
        public TabletBlockHandler(OXSystem oxsystem) : base(oxsystem)
        {
            this.Start();
        }
        ...
        static IActorRef Build()
        {
            ...
            return oxsystem.ActorSystem.ActorOf(Akka.Actor.Props.Create(() => new TabletBlockHandler(oxsystem)));
        }
