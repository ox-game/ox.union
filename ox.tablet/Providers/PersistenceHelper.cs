...
namespace OX.Tablet
{
    public static partial class CasinoPersistenceHelper
    {
        ...
        public static void Save_Bet(this WriteBatch batch, CasinoBlockIndex provider, Block block, BetRequest request, Transaction at, ushort n)
        {
        ...
        public static void Save_RoundClear(this WriteBatch batch, CasinoBlockIndex provider, RoundClear roundClear, ReplyTransaction rt)
        {
        ...
        #region bury
        public static void Save_Bury(this WriteBatch batch, CasinoBlockIndex provider, BlockContext context, BuryRequest request, Transaction at, uint blockIndex, ushort n)
        {
            if (request.IsNotNull())
            {
                var output = at.Outputs[n];
                ...
                if (provider.OXAccount.ScriptHash == request.From)
                {
        ...
        public static void Save_ReplyBury(this WriteBatch batch, CasinoBlockIndex provider, BlockContext context, ReplyBury replyBury, Block block, ReplyTransaction rt)
        {
        ...
        public static void Save_GameMiningSeed(this WriteBatch batch, CasinoBlockIndex provider, Block block, LockAssetTransaction lat, TransactionOutput output, ushort N, GameMiningSeed seed, UInt160 sh)
        {
            if (seed != default)
            {
        ...
        public static void Save_GameMiningAirdrop(this WriteBatch batch, CasinoBlockIndex provider, Block block, LockAssetTransaction lat, TransactionOutput output, ushort N, GameMiningAirdrop airdrop, UInt160 sh)
        {
            if (airdrop != default)
            {
