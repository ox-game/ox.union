...
namespace OX.Tablet
{
    ...
    {
        public static void Save_MixRoom(this WriteBatch batch, CasinoBlockIndex provider, MixRoom room)
        {
        ...
        public static void Save_RoomPartnerLockRecord(this WriteBatch batch, CasinoBlockIndex miningProvider, Block block, ushort txIndex, MixRoom Room, LockAssetTransaction lat, TransactionOutput output, UInt160 recipient)
        {
            if (lat.IsNotNull())
            {
