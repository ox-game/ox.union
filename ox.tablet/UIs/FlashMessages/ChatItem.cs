    ...
    public partial class ChatItem : UserControl
    {
        ...
        public ChatItem(IChatModel chatModel)
        {
            ...
            if (chatModel == null)
            {
                ...
                {
                    Author = "System",
                    Body = UIHelper.LocalString("没有任何信息。", "No messages were found."),
                    IsRemote = true,
                    Time = DateTime.Now
                };
            }
            ...
            switch (chatModel.Type)
            {
                ...
                case "attachment":
                    ...
                    bodyTextBox.Text = UIHelper.LocalString("点击下载:", "Click to download: ") + attachmentmodel.Filename;
        ...
        {
            var gr = RoundedRectangle.Create(this.bodyPanel.ClientRectangle, 7, RoundedRectangle.RectangleCorners.All);
            this.bodyPanel.Region = new Region(gr);
            base.OnPaint(e);
        }
    }
}
