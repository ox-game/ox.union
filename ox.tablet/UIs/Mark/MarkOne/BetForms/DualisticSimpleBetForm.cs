...
{
    public partial class DualisticSimpleBetForm : BaseBetForm
    {
        public virtual uint LeastCodeNumber { get; } = 1;
        public DualisticSimpleBetForm()
        {
            InitializeComponent();
        }
        ...
        {
            foreach (var msc in NoneFlagEnumHelper.All<DualisticSimple>())
            {
        ...
        {
            var methodSetting = MarkOneBetMethod.JYYYTD.GetMethodSetting();
        ...
        public override BitMarkSixBetTarget[] GetBetTargets()
        {
            ...
            foreach (PointSwitch ps in this.GetPointControls())
            {
                if (ps.Checked)
                {
                    ...
                    {
                        Method = (byte)MarkOneBetMethod.JYYYTD,
