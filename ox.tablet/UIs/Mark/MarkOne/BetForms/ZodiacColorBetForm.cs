...
{
    public partial class ZodiacColorBetForm : BaseBetForm
    {
        public virtual uint LeastCodeNumber { get; } = 1;
        public ZodiacColorBetForm()
        {
            InitializeComponent();
        }
        ...
        {
            foreach (var msc in NoneFlagEnumHelper.All<MarkSixColor>())
            {
        ...
        {
            var methodSetting = MarkOneBetMethod.ZodiacColor.GetMethodSetting();
        ...
        public override BitMarkSixBetTarget[] GetBetTargets()
        {
            ...
            foreach (PointSwitch ps in this.GetPointControls())
            {
                if (ps.Checked)
                {
                    ...
                    {
                        Method = (byte)MarkOneBetMethod.ZodiacColor,
