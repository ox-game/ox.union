...
namespace OX.Tablet
{
    ...
    public partial class AgentOrder : UserControl, IBlockchainHandler
    {
        ...
        public MixMarkMember PortMember { get; private set; }
        public MarkPortPlayerTermRecord Record { get; private set; }
        public Fixed8 BondAmount { get; private set; } = Fixed8.Zero;
        public AgentOrder(MixMarkMember portmember, MarkPortPlayerTermRecord record)
        {
            this.PortMember = portmember;
            this.Record = record;
            InitializeComponent();
            this.gb_memberId.Text = portmember.MarkMemberId.ToString();
